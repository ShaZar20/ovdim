...
export default class Type7 extends React.Component {
    constructor(props) {
        ...
        this.state = {
            menalYashir: "",
            deregMelove: ["sdd", "aasss", "sdde", "test1", "test2"],
            menalMerhav: [],
            meloveMeanhaga: ["sdd", "aasss", "sdde", "test1", "test2"],
            textValue1: "",
            textValue2: "",
            textValue3: "",
            textValue4: "",
    ...
    melaveMerhavNameSelect = (name) => {
        if(this.state.menalMerhav.length < 8) {
                ...
                <div className="sub-container">
                    ...
                    <div className="container-selected_names">
                        {this.state.deregMelove && this.state.deregMelove.map((name, i) =>
                            <div  className="selected-input">{name}<TiDelete onClick={(e) => { this.setState(this.state.deregMelove.splice(i,1)); }}/></div> )}
                    </div>
                    ...
                    <div className="container-selected_names">
                        {this.state.menalMerhav && this.state.menalMerhav.map((name, i) =>
                            <div  className="selected-input">{name}<TiDelete onClick={(e) => { this.setState(this.state.menalMerhav.splice(i,1)); }}/></div> )}
                    </div>
                    ...
                    <div className="container-selected_names">
                        {this.state.meloveMeanhaga && this.state.meloveMeanhaga.map((name, i) =>
                            <div  className="selected-input">{name}<TiDelete onClick={(e) => { this.setState(this.state.meloveMeanhaga.splice(i,1)); }}/></div> )}
                    </div>
